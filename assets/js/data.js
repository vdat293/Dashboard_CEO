...
const locationData = {
  ...
  HN: {
    ...
    newCustomers:  [444, 475, 343, 294, 274, 264, 424, 452, 397, 412, 490, 539], // ~30% khách hàng mới
    employees: 85
  },
  ...
  HCM: {
    ...
    newCustomers:  [420, 391, 449, 355, 301, 383, 341, 478, 399, 366, 452, 506], // ~32% khách hàng mới do cạnh tranh cao
    employees: 72
  },
  ...
  DN: {
    ...
    newCustomers:  [307, 329, 254, 221, 199, 316, 360, 338, 191, 186, 210, 293], // ~35% khách hàng mới (du lịch)
    employees: 45
  },
  ...
  HP: {
    ...
    newCustomers:  [178, 171, 156, 142, 133, 123, 137, 130, 124, 119, 113, 127], // ~25% khách hàng mới (đang giảm)
    employees: 38
  },
  ...
  CT: {
    ...
    newCustomers:  [149, 158, 167, 175, 184, 193, 200, 209, 218, 226, 235, 244], // ~33% khách hàng mới (thị trường mới)
    employees: 35
  },
  ...
  NT: {
    ...
    newCustomers:  [258, 280, 150, 130, 120, 300, 335, 315, 126, 116, 137, 240], // ~40% khách hàng mới (du lịch seasonal)
    employees: 32
  },
  ...
  VT: {
    ...
    newCustomers:  [105, 113, 96, 88, 81, 95, 99, 91, 84, 80, 87, 99], // ~28% khách hàng mới
    employees: 28
  }
};
...
const businessDataByMonth = {
  2025: {
    ...
    customers:    [6250, 6115, 5320, 4675, 4395, 5500, 6020, 6485, 5195, 5065, 5850, 6550],
    newCustomers: [1950, 2010, 1693, 1473, 1354, 1755, 1987, 2110, 1613, 1577, 1806, 2146] // ~31% khách hàng mới
  },
  2024: {
    ...
    newCustomers: [1861, 1917, 1615, 1405, 1292, 1674, 1896, 2013, 1539, 1505, 1724, 2048] // Tổng từ locationData
  },
  2023: {
