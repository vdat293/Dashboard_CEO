...
const locationData = {
  ...
  HN: {
    ...
    customers:     [1478, 1582, 1144, 980, 913, 880, 1413, 1506, 1324, 1374, 1632, 1797], // Số KH hoạt động trong tháng
    newCustomers:  [444, 475, 343, 294, 274, 264, 424, 452, 397, 412, 490, 539], // Số KH mới trong tháng (~30%)
    cumulativeCustomers: [12244, 12719, 13062, 13356, 13630, 13894, 14318, 14770, 15167, 15579, 16069, 16608], // Tổng KH tích lũy
    employees: 85
  },
  ...
  HCM: {
    ...
    customers:     [1313, 1221, 1402, 1109, 941, 1198, 1066, 1493, 1248, 1144, 1413, 1582], // Số KH hoạt động trong tháng
    newCustomers:  [420, 391, 449, 355, 301, 383, 341, 478, 399, 366, 452, 506], // Số KH mới trong tháng (~32%)
    cumulativeCustomers: [10820, 11211, 11660, 12015, 12316, 12699, 13040, 13518, 13917, 14283, 14735, 15241], // Tổng KH tích lũy
    employees: 72
  },
  ...
  DN: {
    ...
    customers:     [877, 941, 726, 633, 568, 902, 1029, 967, 545, 530, 600, 837], // Số KH hoạt động trong tháng
    newCustomers:  [307, 329, 254, 221, 199, 316, 360, 338, 191, 186, 210, 293], // Số KH mới trong tháng (~35% - du lịch)
    cumulativeCustomers: [6807, 7136, 7390, 7611, 7810, 8126, 8486, 8824, 9015, 9201, 9411, 9704], // Tổng KH tích lũy
    employees: 45
  },
  ...
  HP: {
    ...
    customers:     [710, 683, 623, 568, 533, 491, 546, 518, 495, 476, 453, 506], // Số KH hoạt động trong tháng
    newCustomers:  [178, 171, 156, 142, 133, 123, 137, 130, 124, 119, 113, 127], // Số KH mới trong tháng (~25% - đang giảm)
    cumulativeCustomers: [5678, 5849, 6005, 6147, 6280, 6403, 6540, 6670, 6794, 6913, 7026, 7153], // Tổng KH tích lũy
    employees: 38
  },
  ...
  CT: {
    ...
    customers:     [453, 480, 507, 530, 557, 585, 607, 634, 661, 684, 711, 738], // Số KH hoạt động trong tháng
    newCustomers:  [149, 158, 167, 175, 184, 193, 200, 209, 218, 226, 235, 244], // Số KH mới trong tháng (~33% - thị trường mới)
    cumulativeCustomers: [3549, 3707, 3874, 4049, 4233, 4426, 4626, 4835, 5053, 5279, 5514, 5758], // Tổng KH tích lũy
    employees: 35
  },
  ...
  NT: {
    ...
    customers:     [645, 699, 376, 326, 299, 750, 837, 787, 314, 289, 342, 600], // Số KH hoạt động trong tháng
    newCustomers:  [258, 280, 150, 130, 120, 300, 335, 315, 126, 116, 137, 240], // Số KH mới trong tháng (~40% - du lịch seasonal)
    cumulativeCustomers: [4758, 5038, 5188, 5318, 5438, 5738, 6073, 6388, 6514, 6630, 6767, 7007], // Tổng KH tích lũy
    employees: 32
  },
  ...
  VT: {
    ...
    customers:     [376, 403, 342, 314, 289, 338, 353, 326, 299, 284, 311, 353], // Số KH hoạt động trong tháng
    newCustomers:  [105, 113, 96, 88, 81, 95, 99, 91, 84, 80, 87, 99], // Số KH mới trong tháng (~28%)
    cumulativeCustomers: [2805, 2918, 3014, 3102, 3183, 3278, 3377, 3468, 3552, 3632, 3719, 3818], // Tổng KH tích lũy
    employees: 28
  }
};
